...
Adafruit_NV3030B tft = Adafruit_NV3030B(TFT_CS, TFT_DC);
// If using the breakout, change pins as desired
//Adafruit_NV3030B tft = Adafruit_NV3030B(TFT_CS, TFT_DC, TFT_MOSI, TFT_CLK, TFT_RST, TFT_MISO);
...
unsigned long testFillScreen() {
  ...
  yield();
  tft.fillScreen(NV3030B_RED);
  yield();
  tft.fillScreen(NV3030B_GREEN);
  yield();
...
unsigned long testText() {
  ...
  unsigned long start = micros();
  tft.setCursor(0, 0);
  tft.setTextColor(NV3030B_WHITE);  tft.setTextSize(1);
  tft.println("Hello World!");
  tft.setTextColor(NV3030B_YELLOW); tft.setTextSize(2);
  tft.println(1234.56);
  tft.setTextColor(NV3030B_RED);    tft.setTextSize(3);
  tft.println(0xDEADBEEF, HEX);
  tft.println();
  tft.setTextColor(NV3030B_GREEN);
  tft.setTextSize(5);
  tft.println("Groop");
  tft.setTextSize(2);
